 ...
 */
final class Version20200823132729 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE parcours (id INT AUTO_INCREMENT NOT NULL, periode VARCHAR(255) NOT NULL COMMENT \'(DC2Type:dateinterval)\', detail VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
