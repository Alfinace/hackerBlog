 ...
 */
final class Version20200823131942 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE languages (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, lire VARCHAR(20) NOT NULL, lecture VARCHAR(20) NOT NULL, orale VARCHAR(20) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
